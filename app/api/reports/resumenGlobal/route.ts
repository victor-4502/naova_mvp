  ...
  try {
    ...
    const resumenGlobal = {
      ...
      distribucionPorCliente: [
        ...
        { cliente: 'Metalúrgica 123', licitaciones: 6, monto: 45000, ahorro: 6800 },
        { cliente: 'Fábrica DEF', licitaciones: 4, monto: 35000, ahorro: 5200 },
        { cliente: 'Taller GHI', licitaciones: 3, monto: 20000, ahorro: 1500 }
      ],
      distribucionPorCategoria: [
        { categoria: 'Tornillería', licitaciones: 18, monto: 120000, participacion: 48 },
      ...
      topProveedores: [
        { proveedor: 'Ferretería Central', licitaciones: 18, monto: 85000, tasaExito: 66.7 },
      ...
      alertas: [
        ...
        {
          tipo: 'proveedor',
          mensaje: 'Materiales ABC redujo participación en 15%. Revisar relación comercial.',
          severidad: 'baja',
          fecha: '2024-05-20'
        },
        {
          tipo: 'cliente',
          mensaje: 'Industrias ABC aumentó frecuencia de compras 25%. Cliente prioritario.',
          severidad: 'baja',
          fecha: '2024-05-22'
        }
      ],
