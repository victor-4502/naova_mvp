...
export async function GET(request: NextRequest) {
  try {
    ...
    licitacionesConOfertas.forEach(tender => {
      ...
      // Calcular ahorro (diferencia entre oferta más cara y la seleccionada)
    ...
    // Productos más frecuentes (solo de licitaciones con ofertas)
    ...
    // Proveedores más frecuentes (solo de licitaciones con ofertas)
    ...
    const comprasPorCliente = {
      ...
      tendencias: {
        ...
        frecuenciaCompra: totalCompras > 0 ? Math.round(180 / totalCompras) : 0, // días promedio
