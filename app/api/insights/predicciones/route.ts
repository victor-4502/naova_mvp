...
export async function GET(request: NextRequest) {
  try {
    ...
    const sampleData: PriceDataPoint[] = [
      { date: '2024-01-01', price: 2.85, quantity: 500, category: 'Torniller├¡a' },
      { date: '2024-02-01', price: 2.90, quantity: 750, category: 'Torniller├¡a' },
      { date: '2024-03-01', price: 2.95, quantity: 600, category: 'Torniller├¡a' },
      { date: '2024-04-01', price: 3.05, quantity: 800, category: 'Torniller├¡a' },
      { date: '2024-05-01', price: 3.15, quantity: 650, category: 'Torniller├¡a' },
      { date: '2024-06-01', price: 3.20, quantity: 700, category: 'Torniller├¡a' }
    ]
      ...
      predicciones: {
        precios: [
          ...
          },
          {
            ...
            confianza: 75,
            factores: ['Precio internacional acero', 'Demanda construcci├│n']
          },
          {
            producto: 'Tuercas M8',
            precioActual: 2.80,
            ...
            confianza: 68,
            factores: ['Competencia', 'Eficiencia producci├│n']
          }
        ],
        demanda: [
          {
        ...
        ahorro: [
          {
            ...
            ahorroEstimado: 12.5,
            confianza: 80,
            recomendacion: 'Comprar en los pr├│ximos 15 d├¡as'
          },
          {
            estrategia: 'Volumen consolidado',
            ahorroEstimado: 8.3,
            confianza: 75,
            recomendacion: 'Agrupar compras de m├║ltiples categor├¡as'
          },
          {
            estrategia: 'Proveedor alternativo',
            ahorroEstimado: 6.7,
            confianza: 70,
            recomendacion: 'Evaluar Materiales ABC para torniller├¡a'
          }
        ]
      },
      insights: [
        {
          tipo: 'alerta',
          mensaje: 'Precios del acero subir├ín 8% en los pr├│ximos 3 meses',
          severidad: 'alta',
          accion: 'Considerar compra anticipada'
        },
        {
          tipo: 'oportunidad',
          mensaje: 'Demanda de torniller├¡a aumentar├í 20% en verano',
          severidad: 'media',
          accion: 'Preparar inventario'
        },
        {
          tipo: 'recomendacion',
          mensaje: 'Tuercas M8 bajar├ín de precio, esperar 2 meses',
          severidad: 'baja',
          accion: 'Posponer compra'
        }
      ],
      metodologia: {
        algoritmo: 'Regresi├│n lineal con factores estacionales',
        datosHistoricos: '12 meses',
        factoresConsiderados: ['Precios hist├│ricos', 'Estacionalidad', 'Inflaci├│n', 'Demanda'],
