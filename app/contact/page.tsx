          ...
          <div className="container-max max-w-4xl">
            ...
            >
              ...
              <p className="text-xl text-gray-800">
                Déjanos tus datos y nuestro equipo se pondrá en contacto contigo en menos de 24 horas
              </p>
            </motion.div>
            ...
            {status === 'success' && (
              ...
              >
                ...
                <p className="text-gray-800 mb-6">
                  Gracias por tu interés en Naova. Nuestro equipo se pondrá en contacto contigo pronto.
                </p>
                <Link href="/">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="trial">Trial Gratuito (30 días)</option>
                  ...
                  <p className="text-sm text-gray-600 text-center">
                    Al enviar este formulario, aceptas que Naova te contacte por email o teléfono.
                  </p>
                </form>
              </motion.div>
            )}
