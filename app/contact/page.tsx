          ...
          <div className="container-max max-w-4xl">
            ...
            >
              ...
              <p className="text-xl text-gray-800">
                D├⌐janos tus datos y nuestro equipo se pondr├í en contacto contigo en menos de 24 horas
              </p>
            </motion.div>
            ...
            {status === 'success' && (
              ...
              >
                ...
                <p className="text-gray-800 mb-6">
                  Gracias por tu inter├⌐s en Naova. Nuestro equipo se pondr├í en contacto contigo pronto.
                </p>
                <Link href="/">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="basic">Plan B├ísico</option>
