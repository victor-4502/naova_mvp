// Script para crear tablas usando el pooler (si la conexión directa no funciona)
const { PrismaClient } = require('@prisma/client')

console.log('🔧 Creando tablas en Supabase...\n')

// Usar DATABASE_URL (pooler) en lugar de DIRECT_URL
...
async function createTables() {
  try {
    ...
    console.log('\n💡 Siguiente paso: Ejecuta "npm run db:seed" para crear usuarios base')
    
  } catch (error) {
    console.log(`\n❌ Error: ${error.message}\n`)
    
    if (error.message.includes('prepared statement')) {
      console.log('💡 El pooler no soporta prepared statements')
      console.log('   Necesitas usar la conexión directa (DIRECT_URL) para crear tablas')
      console.log('   Verifica que DIRECT_URL esté configurada correctamente en .env')
    }
  } finally {
